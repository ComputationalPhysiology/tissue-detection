...
To get an overview of the project, read the [documentation](https://computationalphysiology.github.io/tissue-detection). Here are some resources to help you get started with open source contributions:
